...
1) Create an empty repository on GitHub (do not add a README if you’re pushing this one). Copy its HTTPS URL, e.g. `https://github.com/<your-username>/<repo>.git`.
...
git branch -M main
git add .
git commit -m "Add gRPC HelloWorld: Java server + Python client"
...
Choose a license if you plan to share publicly (e.g., MIT, Apache-2.0). You can add a `LICENSE` file later.
