...
public final class GreeterGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.grpc.Greeter";
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.HelloRequest,
      com.example.grpc.HelloReply> getStreamHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.HelloRequest,
      com.example.grpc.HelloReply> getStreamHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.HelloRequest, com.example.grpc.HelloReply> getStreamHelloMethod;
    if ((getStreamHelloMethod = GreeterGrpc.getStreamHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getStreamHelloMethod = GreeterGrpc.getStreamHelloMethod) == null) {
          GreeterGrpc.getStreamHelloMethod = getStreamHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.HelloRequest, com.example.grpc.HelloReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.HelloReply.getDefaultInstance()))
              .setSchemaDescriptor(new GreeterMethodDescriptorSupplier("StreamHello"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void streamHello(com.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void streamHello(com.example.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.example.grpc.HelloReply> streamHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_STREAM_HELLO:
          serviceImpl.streamHello((com.example.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.HelloWorldProto.getDescriptor();
    }
